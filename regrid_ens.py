...
src_dir_top = '/work/wicker/MPAS_WRF_comp/mpas/run_dirs/'
src_day     = '20240508'

_in_grid_file = '/work/wicker/MPAS_WRF_comp/mpas/run_dirs/20240508/init/wofs_mpas_01.init.nc'

_mpas_file_prefix = "wofs_gsl_%2.2i.history.2024-05-08_%s.%s.00.nc"
